      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#d4af37] rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-2xl font-bold text-[#152847]">V</span>
          </div>
          <h1 className="text-2xl font-bold text-white">Setup Awal</h1>
          <p className="text-white/50 text-sm mt-1">Buat akun admin pertama</p>
        </div>

        <div className="bg-white/10 border border-white/10 rounded-2xl p-8">
          <h3 className="text-white font-semibold mb-6">Buat akun Admin</h3>
          ...
          <div className="space-y-4">
            ...
            >
              {loading ? "Menyimpan..." : "Buat Akun Admin"}
            </button>
          </div>
        </div>
      </div>
